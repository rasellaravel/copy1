 				...
 				<div class="col-12 pad-0">
 					<div class="banner-menu">
 						...
 						<div class="menu-ul">
 							...
 							<span class="menu-li">User Profile</span>
 						</div>
 					</div>
 				</div>
 				<div class="col-12 pad-0">
 					...
 					<div class="card">
 						...
 						<div class="card-body">
 							<form action="{{url('update-user-info')}}" method="post" id="updateUsrInfo"  enctype="multipart/form-data">
 								@csrf
 								<div class="row">
 									<div class="col-6">
 										<div class="form-group">
 											<label>First Name</label>
 											<input type="text" value="{{Auth::user()->name}}" name="first_name" class="form-control">
 										</div>
 										<div class="form-group">
 											<label>Email</label>
 											<input type="email" value="{{Auth::user()->email}}" readonly="" placeholder="mail address" name="email" class="form-control">
 										</div>
 										<div class="form-group">
 											<label>Phone</label>
 											<input type="number" value="{{$user_info->phone}}" placeholder="enter your phone" name="phone" class="form-control">
 										</div>
 									</div>
 									<div class="col-6">
 										<div class="form-group">
 											<label>Last Name</label>
 											<input type="text" value="{{$user_info->last_name}}" placeholder="last name" name="last_name" class="form-control">
 										</div>
 										<div class="form-group">
 											<label>Image</label>
