 ...
 @section('title', __('_lan.wish_list') . ' | BHG WOOD')
 @section('content')
     <section class="igo-breadcrump-wrap my-4">
         <div class="page-title text-center">
             <h3 class="igo-lg-title3">@lang('_lan.wish_list')</h3>
         </div>
     </section>

     <section class="my-5">
         <div class="container" id="favorite_view">
             <div class="row" id="favorite_view_inr">
                 @forelse ($favorites as $item)
                     @include('front-end.pages.cart.wishlist-1', ['item' => $item])
                 @empty
                             ...
                             <div>
                                 <span>
                                     <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px"
                                         ...
                                         y="0px" viewBox="0 0 368 368" style="enable-background:new 0 0 368 368;"
                                         xml:space="preserve">
                                         <g>
                                             <g>
                                                 <g>
