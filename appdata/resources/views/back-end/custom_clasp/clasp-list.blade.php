                ...
                <div class="page-header">
                    ...
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Custom Clasp</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Create A New Custom Clasp</h5>
                                ...
                                <div class="card-block">
                                    ...
                                    <div id="formData">
                                        <form action="" id="custom_clasp_form" role="form"
                                            ...
                                            <div class="tab-content tabs">
                                                <div class="tab-pane active" id="lenEn" role="tabpanel">
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <label for="name_en" class="col-form-label">Clasp <b
                                                                    class="text-danger">*</b></label>
                                                            <input type="text" id="name_en" name="name_en"
                                                                class="form-control check-empty" placeholder="Clasp">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="lenRus" role="tabpanel">
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <label for="name_rus" class="col-form-label">Clasp <b
                                                                    class="text-danger">*</b></label>
                                                            <input type="text" id="name_rus" name="name_rus"
                                                                class="form-control check-empty" placeholder="Застежка">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="lenPt" role="tabpanel">
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <label for="name_pt" class="col-form-label">Clasp <b
                                                                    class="text-danger">*</b></label>
                                                            <input type="text" id="name_pt" name="name_pt"
                                                                class="form-control check-empty" placeholder="Fecho">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="lenEs" role="tabpanel">
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <label for="name_es" class="col-form-label">Clasp <b
                                                                    class="text-danger">*</b></label>
                                                            <input type="text" id="name_es" name="name_es"
                                                                class="form-control check-empty" placeholder="Corchete">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        @include('back-end.custom_clasp.clasp-view')
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="md-modal md-effect-13" id="modal-13">
    <div class="md-content">
        <h3 class="bg-dark">Custom Clasp</h3>
        <div class="well">
            <ul class="nav nav-tabs tabs ctm-tab-b" role="tablist">
                <li class="nav-item">
...
<script>
    ...
    window.base_url = '<?= url('/') ?>';
    window.insert_custom_clasp = '<?= route('admin.insertCustomClasp') ?>';
    window.edit_custom_clasp = '<?= route('admin.getCustomClasp') ?>';
    window.update_custom_clasp = '<?= route('admin.updateCustomClasp') ?>';
    window.delete_custom_clasp = '<?= route('admin.deleteCustomClasp') ?>';
</script>
@endsection