<nav class="navbar header-navbar pcoded-header">
    <div class="navbar-wrapper">
        <div class="navbar-logo" data-navbar-theme="theme4" style="background: wheat">
                        ...
                        <ul class="show-notification row">
                            ...
                            <li class="col-sm-3">
                                ...
                                <div class="row m-b-20">
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{asset('admin-assets/assets/images/mega-menu/01.jpg')}}"
                    alt="Gallery-1">
            </div>
            <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                    src="{{asset('admin-assets/assets/images/mega-menu/02.jpg')}}" alt="Gallery-2">
            </div>
            <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                    src="{{asset('admin-assets/assets/images/mega-menu/03.jpg')}}" alt="Gallery-3">
            </div>
        </div>
        <div class="row m-b-20">
            <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                    src="{{asset('admin-assets/assets/images/mega-menu/04.jpg')}}" alt="Gallery-4">
            </div>
            <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                    src="{{asset('admin-assets/assets/images/mega-menu/05.jpg')}}" alt="Gallery-5">
            </div>
            <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                    src="{{asset('admin-assets/assets/images/mega-menu/06.jpg')}}" alt="Gallery-6">
            </div>
        </div>
                ...
                <ul class="nav-right">
                    ...
                    <li class="header-notification">
                        ...
                        <ul class="show-notification">
                            ...
                            <li>
                                <div class="media">
                                    <img class="d-flex align-self-center" src="{{asset('admin-assets/assets/images/user.png')}}"
            ...
            <span class="badge">9</span>
                    ...
                    <li class="user-profile header-notification">
                        <a href="javascript:void(0)">
                            <img src="{{ asset('admin-assets/assets/images/user.png') }}" alt="User-Profile-Image">
                            <span>
                                {{ @Auth::user()->name }}
                            </span>
                            <i class="ti-angle-down"></i>
                        ...
                        <ul class="show-notification profile-notification">
                            ...
                            <li>
                                ...
                                @else
                                    <a href="{{ route('admin.loginBackSuperAdmin') }}">Login Back Supperadmin</a>
                                @endif
                            </li>
                        </ul>
                    </li>
                ...
                {{-- <div id="morphsearch" class="morphsearch">
                    ...
                    <div class="morphsearch-content">
                        ...
                        <div class="dummy-column">
                            <h2>Popular</h2>
                            <a class="dummy-media-object" href="#!">
                                <img src="{{asset('admin-assets/assets/images/avatar-1.png')}}"
    alt="PagePreloadingEffect" />
    <h3>Page Preloading Effect</h3>
    </a>
    <a class="dummy-media-object" href="#!">
        <img src="{{asset('admin-assets/assets/images/avatar-1.png')}}" alt="DraggableDualViewSlideshow" />
    ...
    <div class="dummy-column">
        <h2>Recent</h2>
        <a class="dummy-media-object" href="#!">
            <img src="{{asset('admin-assets/assets/images/avatar-1.png')}}" alt="TooltipStylesInspiration" />
            <h3>Tooltip Styles Inspiration</h3>
        </a>
        <a class="dummy-media-object" href="#!">
            <img src="{{asset('admin-assets/assets/images/avatar-1.png')}}" alt="NotificationStyles" />
