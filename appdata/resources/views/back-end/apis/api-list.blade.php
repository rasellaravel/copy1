                    ...
                    <div class="page-header">
                        ...
                        <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Api</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <div id="formData">
                                            <form action="" id="api_form" role="form" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <label for="api_key" class="col-form-label">Key <b
                                                                class="text-danger">*</b></label>
                                                        <input type="text" id="api_key" name="api_key"
                                                            class="form-control check-empty" placeholder="api_key"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <div class="dt-responsive table-responsive">
                                            @include('back-end.apis.api-view')
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    ...
    <script>
        $(function() {
            ...
            window.base_url = '{{ url('/') }}';
            window.insert_api = '{{ route('admin.insertApi') }}';
            window.delete_api = '{{ route('admin.deleteApi') }}';
        });
