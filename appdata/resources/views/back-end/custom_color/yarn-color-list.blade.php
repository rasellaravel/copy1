                ...
                <div class="page-header">
                    ...
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Yarn Color</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div id="formData">
                                        <form action="" id="yarn_color_form" role="form" enctype="multipart/form-data">
                                            @csrf
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        @include('back-end.custom_color.yarn-color-view')
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="md-modal md-effect-13" id="modal-13">
    <div class="md-content">
        <h3 class="bg-dark">Yarn Color</h3>
        <div class="well">
            <ul class="nav nav-tabs tabs ctm-tab-b" role="tablist">
                <li class="nav-item">
            ...
            <form action="" id="update_form" role="form" enctype="multipart/form-data">
                ...
                <div class="m-btn-area">
                    ...
                    <button type="button" class="btn btn-success waves-effect md-close submit-modal-upadte"
                        onclick="updateYarnColor()">Save</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    window.base_url = '<?= url('/') ?>';
    window.insert_yarn_color = '<?= route('admin.insertYarnColor') ?>';
    window.edit_yarn_color = '<?= route('admin.getYarnColor') ?>';
    window.update_yarn_color = '<?= route('admin.updateYarnColor') ?>';
    window.delete_yarn_color = '<?= route('admin.deleteYarnColor') ?>';
</script>
@endsection